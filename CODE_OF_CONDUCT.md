...
Examples include demonstrating empathy, respecting differing viewpoints,
giving and gracefully accepting constructive feedback, taking responsibility,
...
publishing others' private information, and other conduct inappropriate in a
professional setting.

## Enforcement responsibilities

Project maintainers clarify and enforce acceptable behavior and may remove,
edit, or reject comments, commits, code, issues, and other contributions that
violate this Code of Conduct. Enforcement decisions should be proportionate,
consistent, and respectful of reporter privacy.
...
the contact route in [`SECURITY.md`](SECURITY.md), clearly marking the report as
a conduct matter. Maintainers will review and investigate promptly and fairly.
All maintainers must respect the reporter's privacy and security.
